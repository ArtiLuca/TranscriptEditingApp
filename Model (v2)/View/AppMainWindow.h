...
namespace Widgets {
class TranscriptViewerWidget;
class TranscriptEditorWidget;
}
...
public:
    ...
    // Which page is currently shown on the right side.
...
private slots:
    ...
    // === Editor Actions ===
    void onNormalizeWhitespaceRequested();
    void onReplaceTextRequested();
    void onMergeWithNextTriggered();
    void onChangeSegmentSpeakerTriggered();
    void onSplitSameSpeakerTriggered();
    void onSplitTwoSpeakersTriggered();
    void onInsertSegmentBelowTriggered();
    void onDeleteCurrentSegmentTriggered();

    // === View mode ===
    void onShowViewerRequested();
    void onShowEditorRequested();
...
private:
    ...
    void showRightPage(RightPage page);
...
private:
    ...
    // Segmented viewer
    Widgets::TranscriptViewerWidget* transcriptViewer = nullptr;
    Widgets::TranscriptEditorWidget* transcriptEditor = nullptr;
    RightPage currentRightPage = RightPage::Placeholder;
    ...
    QAction* actionFontSmaller = nullptr;
    QAction* actionFontLarger  = nullptr;
    QAction* actionFontReset   = nullptr;
    ...
    QAction* actionChangeSpeaker = nullptr;
    QAction* actionMergeWithNext = nullptr;
    QAction* actionNormalizeWhitespace = nullptr;
    QAction* actionReplaceText = nullptr;
    QAction* actionSplitSameSpeaker = nullptr;
    QAction* actionSplitTwoSpeakers = nullptr;
    QAction* actionInsertBelow = nullptr;
    QAction* actionDeleteSegment = nullptr;

    QAction* actionShowViewer = nullptr;
    QAction* actionShowEditor = nullptr;
